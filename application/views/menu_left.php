<div class="cl-sidebar">
        ...
        <div class="menu-space">
          <div class="content">
            <div class="side-user">
              <div class="info">
                <p> 252  / 500 <b>Expedientes</b><a href="#"><i class="fa fa-plus"></i></a></p>
                <div class="progress progress-user">
                  <div style="width: 50%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="40" role="progressbar" class="progress-bar progress-bar-info">
              ...
              <li><a href="#"><i class="fa fa-envelope-o"></i><span>Buzón para alertas Internas</span></a></li>
